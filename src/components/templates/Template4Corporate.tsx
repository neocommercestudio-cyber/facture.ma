...
export default function Template4Corporate({ data, type }: TemplateProps) {
  const { user } = useAuth();
  ...
  />
          ...
          <div className="flex-1 text-center">
            ...
            <h2 className="text-2xl font-semibold mt-5 tracking-widest">
        ...
        {/* Vague blanche qui découpe le bas du header */}
        <svg
      ...
      {/* CLIENT + DATES (inchangé, juste couleurs) */}
...
<div className="px-8 py-6">
  <div className="flex justify-between">
    <div className="w-64 border-2 border-dashed border-[#24445C] rounded-lg h-30 flex items-center justify-center">
      ...
      <div className="relative bg-[#24445C] text-white">
        {/* Vague blanche qui découpe le haut du footer */}
        <svg
