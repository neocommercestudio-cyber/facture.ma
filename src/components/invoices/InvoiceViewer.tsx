...
export default function InvoiceViewer({ invoice, onClose, onEdit, onDownload, onUpgrade }: InvoiceViewerProps) {
    ...
    return `
      ...
      <head>
        ...
        <style>
          ...
          .content {
            margin-bottom: 30mm; /* Espace pour le footer */
          }
  ...
  const getTemplateContent = () => {
    switch (selectedTemplate) {
      case 'template1':
        return generateTemplate1Content();
      case 'template2':
        return generateTemplate2Content();
      case 'template3':
        return generateTemplate3Content();
      case 'template4':
        return generateTemplate4Content();
      case 'template5':
        return generateTemplate5Content();
      default:
        return generateTemplate1Content();
    }
  };

  const generateTemplate1Content = () => {
    return `
      <div style="background: #fff; max-width: 100%; margin: 0; font-family: Arial, sans-serif; padding: 20px;">
        
        <!-- HEADER -->
        <div style="padding: 20px 0; border-bottom: 1px solid #d1d5db; margin-bottom: 20px;">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <div style="display: flex; align-items: center; gap: 20px;">
              ${user?.company?.logo ? `
                <div style="width: 80px; height: 80px; display: flex; align-items: center; justify-content: center;">
                  <img src="${user.company.logo}" alt="Logo" style="max-width: 80px; max-height: 80px; object-fit: contain;" crossorigin="anonymous" />
                </div>
              ` : ''}
              <div>
            ...
            <div style="text-align: right;">
              <h1 style="font-size: 24px; font-weight: bold; color: #111827; margin: 0;">FACTURE</h1>
            </div>
          </div>
        </div>
        ...
        <div style="padding: 20px 0; border-bottom: 1px solid #d1d5db; margin-bottom: 20px;">
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            ...
            <div style="background: #f9fafb; padding: 15px; border-radius: 8px; border: 1px solid #e5e7eb;">
              ...
              <p style="font-size: 11px; color: #374151; text-align: center; margin: 2px 0;">${invoice.client.address || ''}</p>
              <p style="font-size: 11px; color: #374151; text-align: center; margin: 2px 0;"><strong>ICE:</strong> ${invoice.client.ice || ''}</p>
            </div>
            ...
            <div style="background: #f9fafb; padding: 15px; border-radius: 8px; border: 1px solid #e5e7eb;">
              ...
              <p style="font-size: 11px; color: #374151; text-align: center; margin: 2px 0;">
        ...
        <div style="padding: 20px 0; margin-bottom: 20px;">
          <table style="width: 100%; border-collapse: collapse; border: 1px solid #d1d5db;">
            <thead style="background: #f3f4f6;">
              <tr>
                <th style="border: 1px solid #d1d5db; padding: 10px; text-align: center; font-weight: bold; font-size: 11px;">DÉSIGNATION</th>
                <th style="border: 1px solid #d1d5db; padding: 10px; text-align: center; font-weight: bold; font-size: 11px;">QUANTITÉ</th>
                <th style="border: 1px solid #d1d5db; padding: 10px; text-align: center; font-weight: bold; font-size: 11px;">P.U. HT</th>
                <th style="border: 1px solid #d1d5db; padding: 10px; text-align: center; font-weight: bold; font-size: 11px;">TOTAL HT</th>
              </tr>
            </thead>
            <tbody>
              ${invoice.items.map((item: any) => `
                <tr>
                  <td style="border: 1px solid #e5e7eb; padding: 8px; text-align: center; font-size: 10px;">${item.description}</td>
                  <td style="border: 1px solid #e5e7eb; padding: 8px; text-align: center; font-size: 10px;">${item.quantity.toFixed(3)}</td>
                  <td style="border: 1px solid #e5e7eb; padding: 8px; text-align: center; font-size: 10px;">${item.unitPrice.toFixed(2)} MAD</td>
                  <td style="border: 1px solid #e5e7eb; padding: 8px; text-align: center; font-size: 10px; font-weight: bold;">${item.total.toFixed(2)} MAD</td>
                </tr>
              `).join('')}
            </tbody>
          </table>
        ...
        <div style="padding: 20px 0;">
          <div style="display: flex; justify-content: space-between; gap: 20px;">
            ...
            <div style="width: 45%; background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 15px;">
              <p style="font-size: 12px; font-weight: bold; text-align: center; margin-bottom: 10px;">Arrêtée la présente facture à la somme de :</p>
              <p style="font-size: 11px; margin: 0;">• ${invoice.totalInWords}</p>
            </div>
            ...
            <div style="width: 45%; background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 15px;">
              <div style="display: flex; justify-content: space-between; margin-bottom: 5px; font-size: 11px;">
                <span>Total HT :</span>
                <span style="font-weight: bold;">${invoice.subtotal.toFixed(2)} MAD</span>
              </div>
              <div style="margin-bottom: 5px; font-size: 11px;">
                <div style="display: flex; justify-content: space-between;">
                  <span>TVA :</span>
                  <span style="font-weight: bold;">${invoice.totalVat.toFixed(2)} MAD</span>
                </div>
              </div>
              <div style="display: flex; justify-content: space-between; border-top: 1px solid #d1d5db; padding-top: 8px; font-weight: bold; font-size: 12px;">
                <span>TOTAL TTC :</span>
        ...
        <div style="padding: 20px 0;">
          <div style="width: 250px; background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 15px; text-align: center;">
            <div style="font-weight: bold; margin-bottom: 10px; font-size: 11px;">Signature</div>
  ...
  const generateTemplate2Content = () => {
    return `
      <div style="background: #fff; max-width: 100%; margin: 0; border: 1px solid black; font-family: Arial, sans-serif;">
        
        <!-- HEADER -->
        <div style="padding: 20px; border-bottom: 1px solid black; background: black; color: white; text-align: center;">
          <div style="display: flex; align-items: center; justify-content: space-between;">
            ...
            <div style="flex: 1; text-align: center;">
              <h2 style="font-size: 28px; font-weight: bold; margin: 0;">${user?.company?.name || ''}</h2>
              <h1 style="font-size: 20px; font-weight: bold; margin-top: 8px;">FACTURE</h1>
            </div>
            <div style="width: 80px;"></div>
          </div>
        </div>
        ...
        <div style="padding: 20px; border-bottom: 1px solid black;">
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
            <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; border: 1px solid black;">
              <h3 style="font-weight: bold; font-size: 12px; color: black; margin-bottom: 10px; border-bottom: 1px solid black; padding-bottom: 5px; text-align: center;">
                CLIENT : ${invoice.client.name}
              </h3>
              <p style="font-size: 10px; color: black; text-align: center; margin: 2px 0;">${invoice.client.address || ''}</p>
              <p style="font-size: 10px; color: black; text-align: center; margin: 2px 0;"><strong>ICE:</strong> ${invoice.client.ice}</p>
            </div>
            ...
            <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; border: 1px solid black;">
              ...
              <p style="font-size: 10px; color: black; text-align: center; margin: 2px 0;"><strong>Facture N° :</strong> ${invoice.number}</p>
            </div>
          </div>
        </div>
          ...
          <div style="border: 1px solid black; border-radius: 8px;">
            <table style="width: 100%; border-collapse: collapse;">
              <thead style="background: black; color: white;">
                <tr>
                  <th style="border-right: 1px solid white; padding: 8px; text-align: center; font-weight: bold; font-size: 10px;">DÉSIGNATION</th>
                  <th style="border-right: 1px solid white; padding: 8px; text-align: center; font-weight: bold; font-size: 10px;">QUANTITÉ</th>
                  <th style="border-right: 1px solid white; padding: 8px; text-align: center; font-weight: bold; font-size: 10px;">P.U. HT</th>
                  <th style="padding: 8px; text-align: center; font-weight: bold; font-size: 10px;">TOTAL HT</th>
                </tr>
              </thead>
              <tbody>
                ${invoice.items.map((item: any, index: number) => `
                  <tr style="border-top: 1px solid black;">
                    <td style="border-right: 1px solid black; padding: 8px; text-align: center; font-size: 9px;">${item.description}</td>
                    <td style="border-right: 1px solid black; padding: 8px; text-align: center; font-size: 9px;">${item.quantity.toFixed(3)}</td>
                    <td style="border-right: 1px solid black; padding: 8px; text-align: center; font-size: 9px;">${item.unitPrice.toFixed(2)} MAD</td>
                    <td style="padding: 8px; text-align: center; font-weight: 500; font-size: 9px;">${item.total.toFixed(2)} MAD</td>
                  </tr>
                `).join('')}
              </tbody>
            </table>
        ...
        <div style="padding: 20px;">
          <div style="display: flex; justify-content: space-between;">
            <!-- Bloc gauche -->
            <div style="width: 45%; background: #f8f9fa; border: 1px solid black; border-radius: 8px; padding: 15px;">
              <div style="font-size: 11px; font-weight: bold; border-bottom: 1px solid black; padding-bottom: 8px; text-center;">
                <p style="margin: 0;">Arrêtée la présente facture à la somme de :</p>
              </div>
              <div style="font-size: 10px; border-top: 1px solid black; padding-top: 8px;">
                <p style="margin: 0;">• ${invoice.totalInWords}</p>
              </div>
            </div>
            ...
            <div style="width: 45%; background: #f8f9fa; border: 1px solid black; border-radius: 8px; padding: 15px;">
              ...
              <div style="display: flex; justify-content: space-between; margin-bottom: 5px; font-size: 11px;">
                <span>TVA :</span>
                <span style="font-weight: 500;">${invoice.totalVat.toFixed(2)} MAD</span>
              </div>
              <div style="display: flex; justify-content: space-between; font-size: 12px; font-weight: bold; border-top: 1px solid black; padding-top: 8px;">
                <span>TOTAL TTC :</span>
                <span>${invoice.totalTTC.toFixed(2)} MAD</span>
              </div>
            </div>
        ...
        <!-- SIGNATURE -->
        <div style="padding: 20px;">
          <div style="width: 250px; background: #f8f9fa; border: 1px solid black; border-radius: 8px; padding: 15px; text-align: center;">
            <div style="font-size: 11px; font-weight: bold; margin-bottom: 10px;">Signature</div>
            <div style="border: 2px solid black; border-radius: 8px; height: 80px;"></div>
          </div>
        </div>
      </div>
    `;
  ...
  const generateTemplate3Content = () => {
    return generateTemplate1Content(); // Utilise le même contenu pour l'instant
  };

  const generateTemplate4Content = () => {
    return generateTemplate1Content(); // Utilise le même contenu pour l'instant
  };

  const generateTemplate5Content = () => {
    return generateTemplate1Content(); // Utilise le même contenu pour l'instant
  };
